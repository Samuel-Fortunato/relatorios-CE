...
=\left(\frac{1}{5.00\times10^{5}}+\frac{1}{100}\right)^{-1}
=9.9998\times10^{1}\,\Omega\approx1.00\times10^{2}\,\Omega \\[4pt]
R_{\mathrm{eq}}&=R_{13}+R_2=(1.00\times10^{2})+(1.00\times10^{3})
=1.10\times10^{3}\,\Omega \\[4pt]
I_0&=\frac{V_0}{R_{\mathrm{eq}}}=\frac{15}{1.10\times10^{3}}
=1.36\times10^{-2}\,\mathrm{A}=13.6\,\mathrm{mA}=I_2 \\[4pt]
V_2&=I_2R_2=(1.36\times10^{-2})(1.00\times10^{3})
=13.6\,\mathrm{V}, \qquad
V_1=V_3=V_0-V_2=15.0-13.6=1.36\,\mathrm{V} \\[4pt]
I_1&=\frac{V_1}{R_1}=\frac{1.36}{5.00\times10^{5}}
=2.72\times10^{-6}\,\mathrm{A}=2.72\,\mu\mathrm{A}, \qquad
I_3=\frac{V_3}{R_3}=\frac{1.36}{100}=1.36\times10^{-2}\,\mathrm{A}=13.6\,\mathrm{mA}
\end{aligned}
\]
