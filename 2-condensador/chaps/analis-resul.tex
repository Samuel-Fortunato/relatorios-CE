...
Calcula-se então a {\Large \{carga máxima do condensador (verificar)\}} calculando a tensão na resistência $ R_2 $:

\begin{equation}
	V_{max} = V_\text{fonte} \cdot \frac{R_2}{R_1 + R_2} = 15 \cdot \frac{1000}{1000 + 1500} = \qty{6}{V}
\end{equation}

REGRESSAO LINEAR \cref{eq:reg-lin}
\begin{equation} \label{eq:reg-lin}
	f(x) = -0.096338 x 
\end{equation}

Assim, representamos o grafico linearizado, com a regressão linear respetiva:
