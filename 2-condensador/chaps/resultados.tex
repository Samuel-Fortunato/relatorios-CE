...
Inicialmente, verificou-se que a diferença de potencial do condensador era aproximadamente $\qty{0}{\volt}$ quando se fechava o interruptor $S_1$ e se mantinha aberto $S_2$. De seguida, fechou-se $S_2$ e mediu-se o aumento de tensão nas extremidades do condensador durante 42 segundos. Os resultados foram registrados em intervalos de 6 segundos na \cref{tab:carga}:
\begin{table}[!ht]
	\centering
