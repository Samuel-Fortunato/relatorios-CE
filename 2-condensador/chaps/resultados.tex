...
Inicialmente, verificou-se que a diferença de potencial do condensador era aproximadamente 0V. De seguida, fecharam-se os dois interruptores e mediu-se o aumento de tensão nas extremidades do condensador durante 42 segundos. Os resultados foram registrados em intervalos de 6 segundos na Tabela 1.
\begin{table}[!ht]
	\centering
...
Por fim, depois da diferença de potencial do condensador estabilizar. Abriu-se o interruptor $S_1$, de forma que o condensador fosse descarregado apenas pela resistência $R_2$.De sequênicia, registamos a queda de tensão do nos terminais do condensador ao longo de 42 segundos.Os resultados foram registrados em intervalos de 6 segundos na Tabela 2.
