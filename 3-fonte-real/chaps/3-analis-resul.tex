...
\begin{equation}
	...
	\label{eq:regLin1}
\end{equation}
A partir do declive da regressão linear através da Lei de Ohm podemos inferir que a resitência de entrada experimental para o circuito com C e D ligados é $R_E=\pgfmathprintnumber[fixed, precision=3]{\expI}\,\unit{\ohm}$
...
A partir do declive da regressão linear através da Lei de Ohm podemos inferir que a resitência de entrada experimental para o circuito com C e D desligados é $R_E= \pgfmathprintnumber[fixed, precision=3]{\expII} \,\unit{\ohm}$
...
\begin{figure}[!ht]
	...
	\begin{tikzpicture}
		\begin{axis}[
				xlabel={Corrente (\unit{\mili\ampere})},
				ylabel={Tensão (\unit{\volt})},
...
De onde se retira que $V_0 = \pgfmathprintnumber[fixed, precision=3]{\VexpIII}\,\unit{V}$ e $R_i = \pgfmathprintnumber[fixed, precision=3]{\expIII}\,\unit{\ohm}$
...
\begin{align*}
	               ...
	               & R_1 + R_4 = 241,1 \, \Omega                                                \\
	\Rightarrow \, & R_{eq} = 327 + \frac{260 \cdot 241,1}{260 + 241,1} \approx 452,1 \, \Omega
\end{align*}
