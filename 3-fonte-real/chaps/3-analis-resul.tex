...
\begin{figure}[!ht]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[red, domain=5:40] {\slopeI * x + \interceptI};
...
\begin{equation}
	...
	\label{eq:regLin1}
\end{equation}
Dessa maneira, através da Lei de Ohm podemos inferir que a resitência de entrada experimental para o circuito com C e D ligados é $R_E=(383\pm01)\,\unit{\ohm}$
...
\begin{figure}[!ht]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			% --- AND PLOT THE REGRESSION LINE ---
			\addplot[red, thick, domain=5:32.5] {\slopeII * x + \interceptII};
