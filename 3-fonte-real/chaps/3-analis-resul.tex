...
Assim, a partir do declive da regressão linear, inferir-se que a resistência de entrada experimental para o circuito com C e D ligados é $R_E=\pgfmathprintnumber[fixed, precision=3]{\expI}\,\unit{\ohm}$.
...
\paragraph{\textbf{Valor teórico:}}
Os valores teóricos foram determinados com base nos valores experimentais da \cref{tab:resist-exper}.

\begin{equation*}
	R_E= R_1+ R_3 +R_4 = 120,5+ 260,0 +120,6 = \pgfmathprintnumber[fixed, precision=3]{\teoII}\,\Omega
\end{equation*}
...
\begin{align*}
	               ...
	               & R_1 + R_4 = 241,1 \, \Omega                                                                                                 \\
	\Rightarrow \, & R_{eq} = 327,0 + \frac{260,0 \cdot 241,1}{260,0 + 241,1} \approx \pgfmathprintnumber[fixed, precision=3]{\teoIII} \, \Omega
\end{align*}
...
\begin{align*}
	V_{Th} = V_3 = V_s \, \frac{R_3}{R_1+R_3+R_4} = 15 \cdot \frac{260,0}{501,1} = \pgfmathprintnumber[fixed, precision=3]{\VteoIII}\,\unit{V}
\end{align*}

Por fim, calculou-se a exatidão do valor experimental obtido com a equação \eqref{eq:exatidao}.
\begin{equation*}
	\text{Exatidão} = \left(1 - \frac{|447,9 - 452,1|}{452,1}\right)\times 100 = \pgfmathprintnumber[fixed, precision=3]{\exatIII}\%
\end{equation*}
